    ...
    <ul class="nav">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="{{ url('/TourManage/addTourCategory') }}">Add Tour
                            Category</a></li>
                    <li class="nav-item"> <a class="nav-link" href="{{ url('/TourManage/ViewCategories') }}">View Tour
                            Categories</a></li>
                </ul>
            </div>
        </li>
        <li class="nav-item">
            ...
            <div class="collapse" id="ui-advanced">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="{{ url('/TourManage/CreatePackage') }}">Add a Tour
                            Package</a></li>
                    <li class="nav-item"> <a class="nav-link" href="{{ url('/TourManage/ViewPackages') }}">View All
                            Packages</a></li>
                </ul>
            </div>
        </li>
        <li class="nav-item nav-category {{ Request::is('/TestimonialGuides/*') ? 'active' : '' }}">Testimonial &nbsp;
            and Guides</li>
        <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"><a class="nav-link"
                            href="{{ url('/TestimonialGuides/CreateTestimonail') }}">Add Testimonial</a></li>
                    <li class="nav-item"><a class="nav-link"
                            href="{{ url('/TestimonialGuides/ManageTestimonail') }}">Manage Testimonails</a></li>
                </ul>
            </div>
        </li>
        <li class="nav-item">
            ...
            <div class="collapse" id="auth">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link"
                            href="{{ url('/TestimonialGuides/CreateTravelGuide') }}">Add Travel Guide </a></li>
                    <li class="nav-item"> <a class="nav-link"
                            href="{{ url('/TestimonialGuides/ManageTravelGuide') }}">Manage Travel Guides </a></li>
                </ul>
            </div>
        </li>
