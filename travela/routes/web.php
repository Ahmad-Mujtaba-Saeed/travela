...
Route::get('/Readmore', [ToursController::class, 'Readmore'])->name('Readmore');
Route::get('/CategoryPackages',[ToursController::class, 'CategoryPackages'])->name('CategoryPackages');
